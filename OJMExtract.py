...
class OJMExtract():
    ...
    def rearrange(self, buf_encoded):
        ...
        for block in range(17):
            ...
            block_start_plain = block_size * self.REARRANGE_TABLE[key]
            buf_plain[block_start_plain:block_size] = buf_encoded[block_start_encoded:block_size]
            key += 1
    ...
    def parse_OMC(self):
        ...
        while pos < ogg_start:
            ...
            sample_rate = int(self.LE(self.hexdata[pos+34:pos+40]), 16)
